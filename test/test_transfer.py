...
def test_tf2zpk():
    ...
    assert_almost_equal(z[0], -1.00000293 +5.07009147e-06j)
    assert_almost_equal(z[1], -1.00000293 -5.07009147e-06j)
    assert_almost_equal(z[2], -0.99999415 +0.00000000e+00j)
