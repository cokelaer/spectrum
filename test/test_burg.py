...
from spectrum.datasets import data_cosine, marple_data
...
def test_arburg_imag_output():
    ...
    a_e, b_e, c_e = (
        numpy.array(
            [
                2.70936368 - 0.77610302j,
                5.17482864 - 2.73293024j,
                7.03527787 - 6.15070038j,
                7.89423853 - 10.20591369j,
                6.84853701 - 14.07469247j,
                4.56915619 - 16.84486008j,
                1.32687590 - 18.13284671j,
                -1.87811360 - 17.49937286j,
                -4.64976221 - 15.05888331j,
                -6.22557823 - 11.25070227j,
                -6.28367510 - 6.93498375j,
                -4.89652279 - 3.24910899j,
                -2.99758653 - 0.8736847j,
                -1.32183647 + 0.04527281j,
        ...
        numpy.array(
            [
                -0.18570222 - 0.87179346j,
                0.26402371 - 0.5190592j,
                0.07162311 - 0.46372011j,
                0.44463099 + 0.05080174j,
                -0.02634972 - 0.14691215j,
                0.19255061 - 0.37032848j,
                -0.25994598 - 0.55924338j,
                -0.20237974 - 0.23641516j,
                -0.40546748 - 0.40598876j,
                -0.47824854 - 0.42553068j,
                -0.51507096 - 0.49435948j,
                -0.32530245 - 0.49134098j,
                -0.21950049 - 0.37261937j,
                -0.28613904 - 0.0921211j,
                -0.35565856 + 0.14754881j,
            ]
        ),
    )
...
def create_figure():
    psd = test_burg()
    pylab.plot(pylab.linspace(-0.5, 0.5, len(psd)), 10 * pylab.log10(psd / max(psd)))
